...
class QuBit_UniversalVariable_Model_Page_Observer {
    ...
    public function getLayout() {
        Mage::log('We loaded getLayout', NULL, 'loadOrder.log');
        return $this->_layout;
    }
    ...
    public function _setLayout($layout) {
        $this->_layout = $layout;
        Mage::log('We loaded setLayout', NULL, 'loadOrder.log');
    }
    ...
    public function _setListing() {
        ...
        if (isset($layout)) {
            if ($this->_isCategory()) {
                $products = $layout->getBlock('product_list')->getLoadedProductCollection();
                $this->_listing = array();
                $productArray = array();
...
//   Mage::log('loading setCatalogProductListing',NULL,'loadOrder.log');    
...
// ###### Removed this as it needs to be done in the block
//    if ($this->_isCategory()) {
//      $this->_setListing();
//    }
//
